...
public class DataBinderTestModel {
	...
	private cn.javass.chapter2.web.model.PhoneNumberModel phoneNumber;//String->自定义对象的转换测试
	private Date date;//日期类型测试
	private cn.javass.chapter2.web.model.UserState state;//String——>Enum类型转换测试
	...
	public cn.javass.chapter2.web.model.PhoneNumberModel getPhoneNumber() {
		return phoneNumber;
	}
	public void setPhoneNumber(cn.javass.chapter2.web.model.PhoneNumberModel phoneNumber) {
	...
	public cn.javass.chapter2.web.model.UserState getState() {
		return state;
	}
	public void setState(cn.javass.chapter2.web.model.UserState state) {
		this.state = state;
	}
	@Override
